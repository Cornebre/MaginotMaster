...
public class MaginotManagerAutoTempShield : IKokoroApi.IV2.IStatusRenderingApi.IHook, IKokoroApi.IV2.IStatusLogicApi.IHook
{
	
	public MaginotManagerAutoTempShield(IPluginPackage<IModManifest> package, IModHelper helper)
	{
